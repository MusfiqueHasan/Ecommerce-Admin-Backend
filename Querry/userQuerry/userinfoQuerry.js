...
async function getUserInfo(userId) {
	const sqlQuerry = `SELECT first_name,last_name,user_name,phone_number,profile_img,division,city,houseNo,landmark,postCode,country FROM user_info WHERE id = ${userId}`;
